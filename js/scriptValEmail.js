//A função validateEmail (anteriormente validateEsqueceu) é usada para validar o campo de e-mail de um formulário.
...
//A função validateEmail é definida para validar o campo de e-mail de um formulário de recuperação de senha.
